...
namespace Modules.ParishManagement.Persistence.Migrations
{
    ...
    [Migration("20250816181441_AddLatLngToMassLocation")]
    partial class AddLatLngToMassLocation
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Modules.ParishManagement.Domain.OtherSchedules.OtherScheduleFile", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.Property<Guid>("OtherScheduleId")
                        .HasColumnType("uuid")
                        .HasColumnName("other_schedule_id");

                    b.Property<DateTime?>("UpdatedAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("updated_at");

                    b.ComplexProperty<Dictionary<string, object>>("UploadInfo", "Modules.ParishManagement.Domain.OtherSchedules.OtherScheduleFile.UploadInfo#UploadInfo", b1 =>
                        {
                            b1.IsRequired();
                    ...
                    b.HasKey("Id")
                        .HasName("pk_other_schedule_file");

                    b.HasIndex("OtherScheduleId")
                        .HasDatabaseName("ix_other_schedule_file_other_schedule_id");

                    b.ToTable("other_schedule_file", "parishmanagement");
                });
            ...
            modelBuilder.Entity("Modules.ParishManagement.Domain.OtherSchedules.OtherScheduleFile", b =>
                {
                    b.HasOne("Modules.ParishManagement.Domain.OtherSchedules.OtherSchedule", null)
                        .WithMany("Files")
                        .HasForeignKey("OtherScheduleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_other_schedule_file_other_schedule_other_schedule_id");
                });
